...
def watcher_payload(
    ...
    return {
        ...
        "mapGeometry": {
            ...
            "playableMinX": map_geometry.playable_min_x,
            "playableMaxX": map_geometry.playable_max_x,
            "playableMinY": map_geometry.playable_min_y,
            "playableMaxY": map_geometry.playable_max_y,
